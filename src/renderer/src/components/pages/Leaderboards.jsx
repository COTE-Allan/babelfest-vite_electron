                ...
                {leaderboardData.map((user) => (
                  ...
                  >
                    ...
                    <span className="value">
                      {selectedLeaderboard === 'MMR' ? `MMR ${user.stats.mmr}`  : `Niveau ${user.level}`}
                    </span>
                  </div>
                ))}
              </div>
              <div className="leaderboard-self">
                <span className={`rank ${getRankClass(myRank)} leaderboard-rank`}>
                  {myRank}
                </span>
                <LeaderboardPlayerBanner user={userInfo} />
                <span className="value">
                  {selectedLeaderboard === 'MMR' ? `MMR ${userInfo.stats.mmr}` : `Niveau ${userInfo.level}`}
                </span>
              </div>
            </>
          ) : (
