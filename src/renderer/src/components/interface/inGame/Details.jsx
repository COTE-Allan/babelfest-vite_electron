                        ...
                        <>
                          ...
                          <ul>
                            {effect.cards.map((infos, index) => {
                              ...
                              return (
                                <li className={`txt-rarity-${card.rarity}`} key={index}>
              ...
              {detailCard.isRecto !== undefined && !detailCard.isRecto && (
                <div className="details-card-effect">
                  ...
                  <div className="details-card-effect-txt">
                    <span>Dissimulé</span>
                    <p>
                      Votre adversaire ne peut pas voir les détails de cette carte, les effets
                      activés par cette carte ne seront pas affichés dans l'historique.
                    </p>
                  </div>
                </div>
              )}
