...
import { getCurrentSeason, getSeasonalsSkins, getSkinsWithLevel } from '../others/toolBox'
...
const RankedInfos = ({ userInfo }) => {
  ...
  const seasonalsSkins = getSeasonalsSkins(currentSeason.id)

  return (
    <div className="rankedInfos">
      <div className="rankedInfos-wrapper">
        <div style={{ backgroundColor: currentSeason.hex + '50' }} className="rankedInfos-header">
        ...
        <div className="rankedInfos-rewards">
          <div
            className="rankedInfos-rewards-item box-bronze"
            style={{ opacity: seasonalsSkins[0] === 'nothing' ? 0 : 1 }}
          >
            {seasonalsSkins[0] && (
              <SkinItem
                rankReward
          ...
          <div
            className="rankedInfos-rewards-item box-argent"
            style={{ opacity: seasonalsSkins[1] === 'nothing' ? 0 : 1 }}
          >
            {seasonalsSkins[1] && (
              <SkinItem
                rankReward
          ...
          <div
            className="rankedInfos-rewards-item box-or"
            style={{ opacity: seasonalsSkins[2] === 'nothing' ? 0 : 1 }}
          >
            {seasonalsSkins[2] && (
              <SkinItem
                rankReward
          ...
          <div
            className="rankedInfos-rewards-item box-diamant"
            style={{ opacity: seasonalsSkins[3] === 'nothing' ? 0 : 1 }}
          >
            {seasonalsSkins[3] && (
              <SkinItem
                rankReward
          ...
          <div
            className="rankedInfos-rewards-item box-maitre"
            style={{ opacity: seasonalsSkins[4] === 'nothing' ? 0 : 1 }}
          >
            {seasonalsSkins[4] && (
              <SkinItem
                rankReward
